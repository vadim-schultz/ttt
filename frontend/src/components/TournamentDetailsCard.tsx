...
export default function TournamentDetailsCard({ tournament }: TournamentDetailsCardProps) {
    ...
    >
      ...
      <VStack align="stretch" gap={3}>
        ...
        <HStack justify="space-between" align="center">
          ...
          <Badge colorScheme={getStatusColor(tournament.status)} variant="solid">
            {tournament.status}
          </Badge>
        </HStack>
        ...
        <HStack justify="space-between" align="center">
          ...
          <Text color="blue.600" _dark={{ color: "blue.400" }} fontWeight="medium">
